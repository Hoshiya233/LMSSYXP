function getVideoListByAjax(filter_str) {
    ...
    $.get("/video-list"+filter_str,function(data, status){
        var aa=`<button class="btn-primary" href="javascript:void(0);" onclick="getVideoListByAjax('')">全部</button>`;
        ...
        var aa=`<button class="btn-primary" href="javascript:void(0);" onclick="getVideoListByAjax('')">我全都要</button>`;
